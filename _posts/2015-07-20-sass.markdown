...
description: Don't be intimidated by Sass or SCSS. These are just preprocessors that can be learned in a matter of a week. Find resources for learning Sass here. 
excerpt: >
