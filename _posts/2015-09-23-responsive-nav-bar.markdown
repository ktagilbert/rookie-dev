...
description: A great first jQuery or JavaScript problem to solve is how to make a responsive menu for your site. See how to make one that changes color on scroll using JavaScript here. 
excerpt: >
